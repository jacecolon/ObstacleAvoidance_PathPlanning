...
void setup()
{
  ...
  two = new Circle(random(400)+200, random(400), random(200)+100 , true);
  size(800,400);
...
//If you observe for long enough, if a vehicle stays within the radius long enough we will eventually
//push himself out. It's weird.
